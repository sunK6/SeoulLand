...
$(function(){ ////////// jQB2 ////////////////////////////////////
    ...
    /////////////////////////////////////////////////////////////
    // 슬라이드 자동넘김 기능과 아래로 이동버튼 클릭시////////////
    // 기능이 동일하므로 이를 익명함수로 만들어서 같이 사용///////
    // 버튼 클릭시에는 자동슬라이드를 지워야해서 코드를 분리함!////
    //////////////////////////////////////////////////////////////

    /*********************************************************** 
        함수명: goSlide
        기능: 사이드배너 (.halban) 슬라이드 아래로 이동하기
    ***********************************************************/
    let goSlide = ()=>{//function(){}축약형

        // 1. 호출확인
        console.log("사이드배너 함수");

        // 2.이동슬라이드 위로 이동하기 
        // 이동원리 :
        // (1) 대상의 top값은 1/4크기인 25%를 설정하여 //
        //     애니메이션이동 //
        // (2) 이동후 슬라이드 첫번째 li를 맨뒤로 이동 (append) //
        // (3) 맨뒤 이동시 top값을 다시 0으로 변경함! //
        sld.animate({top:"-25%"},400,function(){ //애니후
            // 첫번째 li선택
    ...
    ***********************************************************/
    let autoSlide = ()=>{
        ...
        // 2.사이드배너 슬라이드 함수호출(2초간격 인터발)
        autoI = setInterval(goSlide,2000); 
        // ####전달값이 없다면 함수명 쓰는 곳에 함수이름만 쓴다!##### // 

    }; /////// autoSlide 함수 ////////////////////////////////////
    //////////////////////////////////////////////////////////////

    // 익명함수의 최초호출은 반드시 함수코드 아래에서 해야함! *
    // 자동슬라이드함수 호출
    autoSlide();
    ...
    ***************************************************************/
    let clearAuto = ()=>{
        ...
        // 2. 인터발지우기 + 타임아웃지우기
        clearInterval(autoI);//인터발지우기
        clearTimeout(autoT);//타임아웃지우기

        // 3. 일정시간 뒤 인터발 재호출
        autoT = setTimeout(autoSlide,5000);
        // 5초후 자동슬라이드 함수 호출!
        // 위의 2번에서 이 셋팅을 담은 autoT 변수를 지워야
        // 호출한만큼 셋팅되어 실행되는 "실행쓰나미"를 방지할수있다
        // 맨마지막 하나만 남음
    ...
    $(".upb").click(function(){
        ...
        // 마지막 li 맨앞으로 이동(prepend) + top값 -25% + top 값 0 으로 애니메이션
...
$(function(){ ///////// jQB3 ////////////////////////////////////
    ...
    // 방법: 클릭된 li 에 class = "on"넣기(나머지는 빼기)
